...
const que1=document.getElementsByClassName("q1")[0];
const que2=document.getElementsByClassName("q2")[0];
const que3=document.getElementsByClassName("q3")[0];
const que4=document.getElementsByClassName("q4")[0];
const que5=document.getElementsByClassName("q5")[0];
...
pointer1.addEventListener("click" ,() => {
    document.getElementsByClassName('q1')[0].classList.add('bold')
...
pointerup1.addEventListener("click" ,() => {
    document.getElementsByClassName('q1')[0].classList.remove('bold')
...
pointer2.addEventListener("click" ,() => {
    document.getElementsByClassName('q2')[0].classList.add('bold')
...
pointerup2.addEventListener("click" ,() => {
    document.getElementsByClassName('q2')[0].classList.remove('bold')
...
pointer3.addEventListener("click" ,() => {
    document.getElementsByClassName('q3')[0].classList.add('bold')
...
pointerup3.addEventListener("click" ,() => {
    document.getElementsByClassName('q3')[0].classList.remove('bold')
...
pointer4.addEventListener("click" ,() => {
    document.getElementsByClassName('q4')[0].classList.add('bold')
...
pointerup4.addEventListener("click" ,() => {
    document.getElementsByClassName('q4')[0].classList.remove('bold')
...
pointer5.addEventListener("click" ,() => {
    document.getElementsByClassName('q5')[0].classList.add('bold')
...
pointerup5.addEventListener("click" ,() => {
    document.getElementsByClassName('q5')[0].classList.remove('bold')
